...
from isaaclab_tasks.manager_based.manipulation.stack.config.tm7s.stack_ik_rel_tm7s_env_cfg import TM7SCubeStackEnvCfg


@configclass
class TM7SCubeStackIKRelMimicEnvCfg(TM7SCubeStackEnvCfg, MimicEnvCfg):
    """
    Isaac Lab Mimic environment config class for TM7S Cube Stack IK Rel env.
    """
    ...
    def __post_init__(self):
        ...
        self.subtask_configs["tm7s"] = subtask_configs
